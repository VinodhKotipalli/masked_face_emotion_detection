# train model using modified labels
# based on tutorial found here https://www.pyimagesearch.com/2019/12/16/training-a-custom-dlib-shape-predictor/
...
ap.add_argument("-i", "--training", required=True,
